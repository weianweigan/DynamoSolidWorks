using Du.DynamoSolidWorks.Models;
using Du.SolidWorks;
...
namespace Du.DynamoSolidWorks
{
    ...
    public static class IdlePromise
    {
        ...
        internal static void ExecuteOnIdleAsync(Action p,
            SolidWorks.ISolidWorksAddin completionHandler = null)
        {
    ...
    {
        public DynamoRevitCommandData(string externalCommandData)
        {
        ...
        //     command.
        public ISolidWorksAddin Application { get; set; }
    ...
    public class DynamoSolidWorks
    {
        ...
        private static SolidWorksDynamoModel revitDynamoModel;
        ...
        public bool Execute(string commandData, ref string message)
        {
